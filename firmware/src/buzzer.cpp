...
static struct buzzer_note melody_mario2[] = {
    ...
    {NOTE_CS4, 55}, {0, 55.0},
    {NOTE_D4, 55}, {0, 55.0},
    {NOTE_CS4, 166}, {0, 166.0},
    {NOTE_DS4, 166}, {0, 166.0},
    {NOTE_DS4, 166}, {0, 166.0},
    {NOTE_GS3, 166}, {0, 166.0},
    {NOTE_G3, 166}, {0, 166.0},
    {NOTE_CS4, 166}, {0, 166.0},
    {NOTE_C4, 55}, {0, 55.0},
    {NOTE_FS4, 55}, {0, 55.0},
    ...
    {NOTE_AS4, 55}, {0, 55.0},
    {NOTE_A4, 55}, {0, 55.0},
    {NOTE_GS4, 100}, {0, 100.0},
    {NOTE_DS4, 100}, {0, 100.0},
    {NOTE_B3, 100}, {0, 100.0},
    {NOTE_AS3, 100}, {0, 100.0},
    {NOTE_A3, 100}, {0, 100.0},
    {NOTE_GS3, 100}, {0, 100.0},
    {0, 333}, {0, 333.0},
    {0, 333}, {0, 333.0},
    {0, 333}, {0, 333.0},
    {0, 0}
