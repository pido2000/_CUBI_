...
TERMINAL_COMMAND(imu_debug, "imu data")
{
            ...
            terminal_io()->print(gyro_y);
            terminal_io()->print("GYRO Z ");
            terminal_io()->print(gyro_z);
            terminal_io()->print("ACC X ");

            terminal_io()->print(acc_x);
            terminal_io()->print("ACC Y ");
            terminal_io()->print(acc_y);
            terminal_io()->print("ACC Z ");
            terminal_io()->print(acc_z);
            ...
            terminal_io()->print(pitch); 
            terminal_io()->print("SMOOTH PITCH ");
            terminal_io()->print(smooth_pitch);    
            terminal_io()->println();
}

TERMINAL_COMMAND(test_imu, "imu data")
{
    imu_tick();
}